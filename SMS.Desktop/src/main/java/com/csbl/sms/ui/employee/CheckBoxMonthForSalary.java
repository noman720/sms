...
public class CheckBoxMonthForSalary extends javax.swing.JDialog {
    JPanel panel = new JPanel();
    SalaryPaymentForm salaryPaymentForm;

    public CheckBoxMonthForSalary(java.awt.Frame parent, boolean modal, SalaryPaymentForm salaryPaymentForm) {
        super(parent, modal);
        this.salaryPaymentForm = salaryPaymentForm;
        initComponents();
...
private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {                                         
    ...
    salaryPaymentForm.setSelectedMonths(selectedMonthList);
    salaryPaymentForm.refreshWindow(salaryPaymentForm);
